 ...
 */
public class AddTraceJson implements Serializable {
    ...
    public AddTraceJson(String discription, String location, String datetime, Integer userid, Double latitude, Double longitude, List<StoryFile> travlenotespictures, Integer rightType) {
